  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center mb-8">
        ...
        <div>
          <h1 className="text-2xl font-semibold mb-3">Car Detailing</h1>
          <p className="text-zinc-600 mb-2">Deep cleaning and protection services to restore showroom shine.</p>
          <ul className="list-disc ml-5 text-zinc-700 space-y-1">
            <li>Interior steam wash and sanitization</li>
            <li>Exterior polish, waxing, and sealants</li>
            <li>Ceramic coating and PPF options</li>
          </ul>
        </div>
      </div>
