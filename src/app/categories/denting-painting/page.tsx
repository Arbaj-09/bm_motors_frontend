  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Car Denting and Painting</h1>
              <p className="text-xl text-blue-100 mb-8">High-quality dent repair and OEM-matched painting in a dust-free booth. Restore your car's factory-fresh appearance.</p>
            ...
            <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl">
              <Image src="https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=800&q=80" alt="Car Painting Service" fill className="object-cover" priority />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold mb-3 text-center text-gray-900">Our Denting & Painting Services</h2>
        <p className="text-center text-gray-600 mb-12 text-lg">Professional body work and painting solutions</p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {icon: "🔨", title: "Panel Beating", desc: "Expert bodyline restoration"},
            {icon: "🎨", title: "Color Matching", desc: "Computerized color blending"},
            {icon: "✨", title: "Scratch Repair", desc: "Scuff and rust treatment"},
            {icon: "🖌️", title: "Full Repaint", desc: "Complete body repainting"}
          ].map((service, i) => (
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-10 md:p-12 text-center">
            <h3 className="text-3xl font-bold mb-4 text-white">Get Professional Denting & Painting</h3>
            <p className="text-xl text-blue-100 mb-8">Factory-finish quality with warranty</p>
